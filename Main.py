...
# Definitions
# IN PROGRESS...
def yes_no_confirmation(question):
    yes = ["Yes", "Y", "yes", "y"]
    no = ["No", "N", "no", "n"]
    while question in no:
...
print("Please Enter Your Birthday Starting With MM")
...
print("Please Review: Your Loan Amount Of $" + loanAmount, "With A Down Payment Of $" + downPayment, "For A Term Of ",
      loanTerm, "Months At An Annual Percentage Rate Of", loanAPR + "% And The Tax Percentage Of", taxPercentage + "%")
print("Please Type Yes/Y Or No/N")
...
print("Done!")
# print("Your Monthly Payment: ", monthlyTotalAfterTax)
